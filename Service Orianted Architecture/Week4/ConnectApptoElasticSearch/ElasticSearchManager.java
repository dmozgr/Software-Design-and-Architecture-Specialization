...
public class ElasticSearchManager {
    ...
    private static final String INDEX = "272018727"; // TODO: MUST CHANGE THIS to random number string
    ...
    public static class RemoveBidTask extends AsyncTask<Bid,Void,Boolean> {
        ...
        protected Boolean doInBackground(Bid... params) {
            ...
            try {
                DocumentResult execute = client.execute(new Delete.Builder(bid_to_delete.getBidId()).index(INDEX).type(USER_TYPE).build());
                if(execute.isSucceeded()) {
                    Log.i("ELASTICSEARCH", "Delete item was successful");
                    success = true;
                } else {
